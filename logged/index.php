<?php
	...
	$query = "select * from pesan where penerima = '$user'";
		...
		<div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--6-col" style="margin:auto;margin-top:5%;">
			<div class="mdl-card__title mdl-color--indigo mdl-color-text--white">
				...
				<ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="demo-menu-lower-right">
				  ...
				  <li class="mdl-menu__item" style="border-bottom:1px solid gray"><a href="outindex.php">Pesan Keluar</a></li>
						...
						<table class='mdl-data-table mdl-js-data-table mdl-shadow--4dp' style='margin:auto;'>
						  <thead>
						    <tr>
						      ...
						      <th class='mdl-data-table__cell--non-numeric'>Pengirim</th>
					...
					while ( $row = mysql_fetch_array($result)) {
						...
						echo "
						    <tr>
						      ...
						      <td class='mdl-data-table__cell--non-numeric'>".$row['pengirim']."</td>";
						if ($cekMAC != $row['MAC']) {
							echo "
